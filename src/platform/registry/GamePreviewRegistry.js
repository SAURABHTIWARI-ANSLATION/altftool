...
export const GamePreviewRegistry = {
    ...
    "dog-simulator-3d": loadGame(() => import("@/games/dog-simulator-3d/Game")),
    "subway-surfers": loadGame(() => import("@/games/subway-surfers/Game")),
    "traffic-dodge-3d": loadGame(() => import("@/games/traffic-dodge-3d/Game")),
    "stunt-bike-extreme": loadGame(() => import("@/games/stunt-bike-extreme/Game")),
    "hill-climb-racing-lite": loadGame(() => import("@/games/hill-climb-racing-lite/Game")),
    "temple-run-2": loadGame(() => import("@/games/temple-run-2/Game")),
    "rally-racer-dirt": loadGame(() => import("@/games/rally-racer-dirt/Game")),
